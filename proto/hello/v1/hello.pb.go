...
const file_hello_v1_hello_proto_rawDesc = "" +
	...
	"\bSayHello\x12\x19.hello.v1.SayHelloRequest\x1a\x1a.hello.v1.SayHelloResponseB\x99\x01\n" +
	"\fcom.hello.v1B\n" +
	"HelloProtoP\x01Z<github.com/menawar/ecommerce-platform/proto/hello/v1;hellov1\xa2\x02\x03HXX\xaa\x02\bHello.V1\xca\x02\bHello\\V1\xe2\x02\x14Hello\\V1\\GPBMetadata\xea\x02\tHello::V1b\x06proto3"
