...
type AddItemRequest struct {
	...
	Quantity      int32                  `protobuf:"varint,3,opt,name=quantity,proto3" json:"quantity,omitempty"` // amount to ADD (must be > 0)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type UpdateItemRequest struct {
	...
	UserId        string                 `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	ProductId     string                 `protobuf:"bytes,2,opt,name=product_id,json=productId,proto3" json:"product_id,omitempty"`
	Quantity      int32                  `protobuf:"varint,3,opt,name=quantity,proto3" json:"quantity,omitempty"` // absolute quantity; 0 removes the line
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_cart_v1_cart_proto_rawDesc = "" +
	...
	"\tClearCart\x12\x19.cart.v1.ClearCartRequest\x1a\x1a.cart.v1.ClearCartResponseB\x91\x01\n" +
	"\vcom.cart.v1B\tCartProtoP\x01Z:github.com/menawar/ecommerce-platform/proto/cart/v1;cartv1\xa2\x02\x03CXX\xaa\x02\aCart.V1\xca\x02\aCart\\V1\xe2\x02\x13Cart\\V1\\GPBMetadata\xea\x02\bCart::V1b\x06proto3"
...
var file_cart_v1_cart_proto_goTypes = []any{
	...
	(*UpdateItemRequest)(nil),  // 6: cart.v1.UpdateItemRequest
	(*UpdateItemResponse)(nil), // 7: cart.v1.UpdateItemResponse
...
var file_cart_v1_cart_proto_depIdxs = []int32{
	...
	6,  // 7: cart.v1.CartService.UpdateItem:input_type -> cart.v1.UpdateItemRequest
	...
	7,  // 12: cart.v1.CartService.UpdateItem:output_type -> cart.v1.UpdateItemResponse
