...
type RegisterRequest struct {
	...
	// it immediately, and it is NEVER stored. (Phase 1 runs without TLS locally;
	// the gateway terminates TLS in a real deployment.)
...
type LoginResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AccessToken   string                 `protobuf:"bytes,1,opt,name=access_token,json=accessToken,proto3" json:"access_token,omitempty"` // signed JWT
	ExpiresAt     int64                  `protobuf:"varint,2,opt,name=expires_at,json=expiresAt,proto3" json:"expires_at,omitempty"`      // token expiry, unix seconds
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\n" +
	"expires_at\x18\x02 \x01(\x03R\texpiresAt2\x86\x01\n" +
	"\vUserService\x12?\n" +
	"\bRegister\x12\x18.user.v1.RegisterRequest\x1a\x19.user.v1.RegisterResponse\x126\n" +
	"\x05Login\x12\x15.user.v1.LoginRequest\x1a\x16.user.v1.LoginResponseB\x91\x01\n" +
